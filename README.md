# ECO Scout Widget TLDR

This widget displays real-time data for environmental conditions for Beyond All Reason.

## Preview

![Preview](https://github.com/bitopsy/ECO-Scout-Widget-for-BAR/blob/main/preview.jpg?raw=true)
